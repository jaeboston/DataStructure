...
router.add_handler("/home/about/me", "me handler")  # add a rout
...
#: edge case with no available route
print(router.lookup("/home/about/test")) # should print 'not found handler'
